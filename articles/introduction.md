...
plot_wealth(raw_wealth, title = "Nominal Wealth Projection (7% Return)")
```

![](introduction_files/figure-html/example-1.png)

``` r
plot_wealth(real_wealth, title = "Inflation-Adjusted Wealth (3% Inflation)")
```

![](introduction_files/figure-html/example-2.png)
